...
class Setting extends React.Component {
  ...
  render(){
    ...
    <div className='setting'>
      ...
      <div className='cet4'><span>是否开启CET4背诵</span><Switch checkedChildren="背诵" unCheckedChildren="不背诵" checked={check4} onChange={this.onChange4} /></div>
      <div className='cet6'><span>是否开启CET6背诵</span><Switch checkedChildren="背诵" unCheckedChildren="不背诵" checked={check6} onChange={this.onChange6} /></div>
    </div>);
  }
}
